...
import 'package:para_final/data/methods/storage_methods.dart';
                  ...
                  if (checkPassword()) {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) => AlertDialog(
                        ...
                        content: const Text(
                            'Your application is under review. Please wait for the confirmation. It will be sent to your email within 2 business days. Until then, you cannot use this account in the meantime.'),
                        actions: <Widget>[
                          TextButton(
                            onPressed: () {
